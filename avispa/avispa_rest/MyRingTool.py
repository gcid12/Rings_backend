...
class MyRingTool:
    ...
    def patch_20141208(self,request,*args):
    ...
    def upgrade_ring(self,request,*args):
        ...
        if handle and ringname:
            ...
            for idx in itemlist:
                ...
                if item_x.store(db): 
                    print('item document saved:',item_id)     
                


        #Grab each one of the items in the DB and check that they have correct structure
  

        #Each item object needs to have the following structure:
